...
core_dependencies = [
    ...
    'arrow',
    'num2words',
    'tendril-utils-core>=0.1.16',
    'tendril-config>=0.1.9',
    'tendril-utils-www>=0.1.8',
]
...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-types',
    project_urls={
        'Documentation': 'https://tendril-utils-types.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-types/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-types',
    },
